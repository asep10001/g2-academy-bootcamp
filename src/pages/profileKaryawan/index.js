            ...
            >
              ...
              <div className="uk-child-width-expand@s uk-text-center uk-grid">
                <ul className="uk-list">
                  <li>Nik: ==== {this.props.data.nik}</li>
                  <li>Name: ==== {this.props.data.name}</li>
                  <li>BIrth Date: ==== {this.props.data.birthDate}</li>
                  <li>Address: ==== {this.props.data.address}</li>
                  <li>Religion: ==== {this.props.data.religion}</li>
                  <li>Citizenship: ==== {this.props.data.citizenship}</li>
                  <li>Email: ==== {this.props.data.email}</li>
                  <li>Division: ==== {this.props.data.division}</li>
                </ul>
              </div>
            </div>
          </div>
